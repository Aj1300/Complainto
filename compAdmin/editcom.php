...
if(isset($_GET["id"])){
    $id=$_GET['id'];
    $sql="select * from usercomp where cid =$id";
    ...
    if(isset($_POST['submit'])){
      ...
      $sqll = "UPDATE usercomp SET name='".$_POST['name']."',mobile='".$_POST['mobile']."',area='".$_POST['area']."',compcat='".$_POST['section']."',compdesc='".$_POST['desc']."' WHERE cid=$id";
    ...
    <div class="form-container">
      ...
      <form  method="POST">
        <div class="form-group">
          ...
          <input type="text" id="name" name="name" value="<?php echo $namee;?>" required>
        </div>

          <div class ="form-group">
            <label for="Select Your Area"><b>Select Your Area</b></label>
    <select id="area" name="area" >
      <option value="<?php echo $areaa;?>"><?php echo $areaa;?></option>
      ...
      <option value="Tanveer Town">Tanveer Town</option>
        ...
        <div class="form-group">
            ...
            <input type="text" id="mobile" value="<?php echo $mobilee;?>" name="mobile" required>
          </div>
          <div class="form-group">
            <div id="formsection">
        ...
        <div class="form-group">
          ...
          <textarea id="desc" name="desc"  rows="4"><?php echo $descc;?>"</textarea>
        </div>
        <div class="form-group">
